# BLEServer
## BLEServer first try
ESP32 BLE kütüphaneleri ile temel bir ble server kurduktan sonra service ve characteristicler tanımlandıktan sonra  bunlara özellikler ve değer tanımlandı. 
Servicelerden biri serial monitörden anlık olarak alınan veriyi , kendisine bağlanan client cihaz ile paylaşmakta.       
```ruby
#include <BLEDevice.h>
#include <BLEUtils.h>
#include <BLEServer.h>
